define("./workbox-9a0ba6e5.js",['exports'], function (exports) { 'use strict';
    ...
    */
    ...
    const OBJECT_STORE_NAME$1 = 'requests';
    ...
    class QueueStore {
      ...
      constructor(queueName) {
        ...
        this._db = new DBWrapper(DB_NAME$1, DB_VERSION, {
      ...
      async pushEntry(entry) {
        ...
        await this._db.add(OBJECT_STORE_NAME$1, entry);
      }
      /**
      ...
      async unshiftEntry(entry) {
        ...
        const [firstEntry] = await this._db.getAllMatching(OBJECT_STORE_NAME$1, {
          count: 1
        });
      ...
      async getAll() {
        return await this._db.getAllMatching(OBJECT_STORE_NAME$1, {
          index: INDEXED_PROP,
      ...
      async deleteEntry(id) {
        await this._db.delete(OBJECT_STORE_NAME$1, id);
      }
      /**
      ...
      async _removeEntry({
        ...
        const [entry] = await this._db.getAllMatching(OBJECT_STORE_NAME$1, {
          direction,
          index: INDEXED_PROP,
          query: IDBKeyRange.only(this._queueName),
          count: 1
      ...
      _upgradeDb(event) {
        ...
        if (event.oldVersion > 0 && event.oldVersion < DB_VERSION) {
          if (db.objectStoreNames.contains(OBJECT_STORE_NAME$1)) {
            db.deleteObjectStore(OBJECT_STORE_NAME$1);
          }
        }

        const objStore = db.createObjectStore(OBJECT_STORE_NAME$1, {
          autoIncrement: true,
          keyPath: 'id'
        });
    ...
    */
    ...
    const MAX_RETENTION_TIME$1 = 60 * 48; // Two days in minutes
    ...
    */
    ...
    const initialize = (options = {}) => {
      ...
      const bgSyncPlugin = new BackgroundSyncPlugin(QUEUE_NAME, {
        maxRetentionTime: MAX_RETENTION_TIME$1,
